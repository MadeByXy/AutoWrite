...
填报内容 = {
    # 经常调整的内容, \n或中文分号(；)换行
    "工作内容": "和客户进行开发进度及开发内容确认工作；跟进项目储备需求导入功能及计划编制模块开发，帮助开发解决业务疑问；熟悉江苏“基于大数据平台的调控数据统计分析应用完善提升项目”项目；完成公司经营管理网上平台集成系统的整理及2019年计划下达结果的整理；完成公司经营管理网上平台日报编写。",
    "明日计划": "跟进项目储备需求导入功能及计划编制模块开发，帮助开发解决业务疑问；熟悉江苏“基于大数据平台的调控数据统计分析应用完善提升项目”项目；完成公司经营管理网上平台日报编写。",
    "遗留问题": "",
    "备注": "",
